<template>
  <div class="ec1_item" id="echarts_G"></div>
</template>
...
const init = () => {
  ...
  const myChart = echarts.init(document.getElementById("echarts_G"));
  ...
  resizeObserver.observe(document.getElementById("echarts_G"));
};
onMounted(() => {
  clacBaseFontSize();
  init();
