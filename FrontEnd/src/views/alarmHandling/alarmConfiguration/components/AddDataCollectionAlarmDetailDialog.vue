...
import {
  getAlarmLevelList, getBaseUserList, getAlarmEquipmentThingModels,
...
const dialogTitle = ref('新增采集数据异常告警')
const formAlarm = ref()
...
defineExpose({
  open: async (id) => {
    ...
    getAlarmEquipmentThingModels({ alarmType: 3 }).then((res: any) => {
