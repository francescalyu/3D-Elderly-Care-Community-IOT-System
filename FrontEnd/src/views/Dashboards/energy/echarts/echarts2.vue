<template>
  <div class="ec1_item" id="ecsmartDashboard2"></div>
</template>
...
const init = () => {
  console.log(props.dataTime, props.dataItem[props.dataType]);
  var timeType = "";
  ...
  const option9 = {
    ...
    series: [
      ...
      // },
      {
        ...
        data: props.dataItem[props.dataType],
      },
    ],
  };
  if (props.dataType == "1") {
  ...
  const myChart = echarts.init(document.getElementById("ecsmartDashboard2"));
  ...
  resizeObserver.observe(document.getElementById("ecsmartDashboard2"));
};
watch(
  () => [props.dataTime],
  () => {
